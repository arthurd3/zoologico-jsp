package com.zoologico.model.animal;
...
public class Animal {
    ...
    public Animal(Long id, String name_popular, String name_scientific, String species, String habitat, String gender, String arrival_date, String health_status, String enclosure_name) {
        this.id = id;
