...
public class UserRegisterController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        UserDTO userDto = new UserDTO(null , name , email , password , phone , UserType.CLIENT);
        boolean successRegister  = userService.registerUser(userDto);

        if(successRegister)
            resp.sendRedirect("/jsp/pages/registro.jsp?successRegister=true");
        else
            resp.sendRedirect("/jsp/pages/registro.jsp?successRegister=false");
